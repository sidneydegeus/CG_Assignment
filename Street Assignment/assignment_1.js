// Made by Sidney de Geus (S1113288) and Jordan Munk (S1113349)
// define variables
...
function initMeshes() {
    ...
    for (i = 0; i < 31; i++) {
        if(i % 3 == 0) {
            ...
            createTree(xPlace-3, 1, -5.6);
            createTree(xPlace-3, 1, 1.9);
        ...
        createHouse(xPlace, 2, -10.6, false);
        createHouse(xPlace, 2, 6.6, true);
...
//Function to create a random integer with min and max
...
function initStreet(){
    ...
    var cube1Material = new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture('wall.jpg')
    });
    ...
    var cube2Material = new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture('straat.jpg')
    });
...
function createHouse(xValue, yValue, zValue, rotated){
    ...
    var doorMaterial = new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture('door.png')
    });
    ...
    var windowMaterial = new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture('window.jpg')
    });
    ...
    var cylinderMaterial = new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture('roof.jpg')
    });
